...
import net.anumbrella.lkshop.ui.activity.AboutActivity;
        ...
        if (BaseUtils.checkLogin(mContext)) {
            ...
            switch (view.getId()) {
                ...
                case R.id.custom_service:
                    builder.setTitle("开发联系人");
                    String desc = "薛树凯 1412190431\n浙江工商大学 软件14A\n";
...
//                    Toast.makeText(getActivity(), "下一版本推出", Toast.LENGTH_SHORT).show();
